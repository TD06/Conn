        ...
        <div className="flex justify-between w-full">
          <span className="text-secondary line-clamp-1 text-sm">
            ...
            <div className="flex items-center gap-1 max-w-[200px] sm:max-w-[250px] md:max-w-[300px] lg:max-w-[200px] xl:max-w-[300px]">
              ...
              {
                data.type === "text" && (
                  <span className="turncate">{data.message}</span>
                )
              }
              {data.type === "audio" &&(
              ...
              {
                data.totalUnreadMessages > 0 && <span className="bg-icon-green px-[5px] rounded-full text-black text-sm ">{data.totalUnreadMessages}</span>
              }
            </div>}
          </span>
        </div>
